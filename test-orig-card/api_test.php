...
//20152705012420F7663B6DFDCEEC34C9B6656BB1E60A
//$res = $api->signInAndGetUser( '000020300032', '111111' );
//var_dump( $res );
//exit;
...
function http_post_json($jsonStr){
	...
	curl_setopt($ch, CURLOPT_URL, "http://192.168.1.102/test-orig-card/service.php");
	...
	$result = $api->parse_card_data($request_result);
	return $result;
}
